...
var dee = '}';
var dpp = '';
var uu = ['777tv.app', '777tv.me', 'gimy.app', 'gimytv.app','ysgc.cc','ysgc.tv','libvioxxxx.com','ysgc.vip'];
var dd = [-1, -1, -1, -1, 'player_aaaa', 'player_aaaa','player_aaaa','player_aaaa'];
var ss = [-1, -1, 'jcplayer', -1, -1, -1, -1, -1];
var ee = [-1, -1, -1, -1,'<', '<', '<','<'];
var nn = ['next', 'next', 'next', 'next','jump', 'jump', 'jump', 'jump'];
//var dpp2 = '&jctype=renrenmi';
var dpp2 = '&jctype=normal';
var pp = [-1, -1, dpp2, dpp2,-1, -1,-1,-1 ];
var url2 = null;
...
if (/dadagui/.test(url)) {
           dss = '';
            url2 = 'bo.dd520.cc/xmplayer';
               ...
               if (/ysgc/.test(url)) {str1 =str1.replace('dplayer.php//', 'dplayer.php');}
